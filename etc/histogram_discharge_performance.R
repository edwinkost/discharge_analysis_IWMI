...
folder_of_analysis_summaries = "/scratch/edwin/IWMI_run_20_nov/without_fossil_limit_with_pumping_limit_CRU/analysis/monthly_discharge/"

# folder and file for these output histograms
histogram_output_location    = "/scratch/edwin/IWMI_run_20_nov/without_fossil_limit_with_pumping_limit_CRU/analysis/monthly_discharge/30min_non_natural_run_nov2014_"
